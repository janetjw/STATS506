...
### b
I used this manual to generate the crosstabulation
...
I used the stata manual on logistic regression and calculating information criteria: 
<https://www.stata.com/manuals/rlogit.pdf>
<https://www.stata.com/manuals/ricnote.pdf>
...
I use this manual to figure out how to conduct a z-test:
<https://www.stata.com/manuals/rztest.pdf>
```stata
...
I used this stack overflow to get a count() table in descending order:
<https://stackoverflow.com/questions/35830859/sorting-output-of-tally-count-dplyr>
```{r}
...
Joining film and film category and then counting from top down
```{r}
dbGetQuery(sakila, "
...
#creating summary table at country table and filtering out which country has 9 occurences. 
