...
Git repository: https://github.com/janetjw/STATS506/blob/main/ProblemSets/JW_PS2.qmd
...
I chose three different values of torque based on the 1st quartile, mean, and third quartile: 177.0, 267.2, 332.0. I select year 2011 since that year has the most observations. We see that cars with higher levels of torque have a stronger relationship between horsepower and mpg on the highway.
...
We get the same coefficient from the linear model, 0.01635563!
I get the same coefficient.
...
Average marginal effects                                 Number of obs = 4,591
Model VCE: OLS

Expression: Linear prediction, predict()
dy/dx wrt:  horsepower
1._at: torque =  177
       year   = 2011
2._at: torque =  257
       year   = 2011
...
horsepower   |
         _at |
          1  |   .0032238   .0022109     1.46   0.145    -.0011106    .0075583
          2  |   .0122123   .0021505     5.68   0.000     .0079963    .0164284
          3  |   .0206391    .002151     9.60   0.000     .0164222     .024856
------------------------------------------------------------------------------

. 
. marginsplot

Variables that uniquely identify margins: torque

. graph export "/Users/janetjw/Dropbox (University of Michigan)/STATS506/ProblemSets/JW_PS2sta
> ta.png", as(png) name("Graph")
file /Users/janetjw/Dropbox (University of Michigan)/STATS506/ProblemSets/JW_PS2stata.png
    saved as PNG format
```

![Margins plot](JW_PS2stata.png "Margins plot")

After running the model, I use the first, second, and third quartile values of torque as representative values for the margins plot. Since hosepower is continuous, I calculate the slope for the relationship for horsepower and mpg on the highway at three representative values of torque, controlling for the other variables in the model. 
